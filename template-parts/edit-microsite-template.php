...
if(is_user_logged_in())
{
	...
	if($microsite_level == 'pro' || $microsite_level == 'premium' || $microsite_level == 'exclusive' || get_current_user_id() == 1827)
	{
		...
		{ ?>
        	<div class="registros_subida"><?php
				...
				if($_POST['insertar_nuevo_curso'] == 'Sí')
				{
					...
					update_field('tipo_de_curso',$_POST['tipo_adr_curso_nuevo'],$post_id);
		...
		while(have_posts())
		{
            ...
            <div class="edit_form_container">
                <form method="post" action="<?php echo get_permalink(get_the_id()).'?edit=true'; ?>" id="form_update_autoescuela_<?php echo get_the_id(); ?>" enctype="multipart/form-data">
                    ...
                    <!-- #Content -->
                    <div id="Content" microsite-color="<?php echo str_replace('#','',$color_microsite); ?>" color-texto="<?php echo str_replace('#','',$tcolor); ?>">
                        <div class="content_wrapper clearfix"><?php
                            ...
                            <div class="header_microsite new" style="background-color:<?php echo $color_microsite; ?>;">
                                <div class="cabecera_contenido">
                                	<?php /*<div class="background_image edit_block numbered">
                                    	<div class="titulo">Cambiar imagen de fondo</div>
                                        <input type="file" name="background_image" id="background_image"><br /><?php
										if($imagen_cabecera != '')
										{ ?>
	                                        <div class="remove_current">
		                                        <input type="checkbox" name="delete_current_bg_image" value="yes"> <label for="delete_current_bg_image">Eliminar imagen actual (se colocará en su lugar una imagen genérica)</label>
        	                                </div><?php
										} ?>
                                    </div>*/ ?>
                                    ...
                                    <div class="texto_cabecera">
                                        ...
                                        { ?>
                                            <div class="descripcion" style="color:<?php echo $tcolor; ?>;"><?php the_field('texto_cabecera'); ?></div><?php
                                        } ?>
                                        <div class="edit_block descripcion numbered">
                                            <div class="titulo" style="color:<?php echo $tcolor; ?>;">Cambiar introducción</div>
                                            <input type="text" name="new_description" id="new_description" value="<?php the_field('texto_cabecera'); ?>">
                                        </div>
                                    </div>
                                ...
                                <section class="detalles_autoescuela section_wrapper mcb-section-inner numbered">
                                    <div class="section_gutter">
                                        <div class="horarios_ubicacion column mcb-column one-second column_column">
                                            <div class="titulo">Horarios y ubicación</div>
                                            <div class="elemento horario"><div class="icono" style="background-color:<?php echo $color_microsite; ?>;"><?php echo file_get_contents(get_stylesheet_directory().'/img/microsites/icono_reloj.svg'); ?></div><input type="text" name="new_horario" id="new_horario" value="<?php the_field('horario'); ?>" placeholder="Horario del centro"></div>
                                            <div class="elemento ubicacion"><div class="icono" style="background-color:<?php echo $color_microsite; ?>;"><?php echo file_get_contents(get_stylesheet_directory().'/img/microsites/icono-lugar.svg'); ?></div><?php $direccion=get_field('mapa'); echo $direccion['address']; /*<input type="text" name="new_direccion" id="new_direccion" value="<?php $direccion=get_field('mapa'); echo $direccion['address']; ?>" placeholder="Dirección del centro"><span class="microsite_tip"><strong>Formato:</strong> C/Nombre de la calle, Número del portal, Otros detalles de la dirección, Código postal, Ciudad, Provincia</span>*/ ?></div>
                                        ...
                                        <div class="telefonos column mcb-column one-second column_column">
                                            <div class="telefonos_container">
                                                <div class="titulo">Datos de contacto</div>
                                                <ul class="telefonos">
                                                   	<li class="elemento"><div class="icono whatsapp" style="background-color:<?php echo $color_microsite; ?>;"><?php echo file_get_contents(get_stylesheet_directory().'/img/microsites/icono-whatsapp.svg'); ?></div><input type="text" name="new_tlf_fijo" id="new_tlf_fijo" value="<?php the_field('telefono_fijo'); ?>" placeholder="Teléfono fijo del centro"></li>
                                                    <li class="elemento"><div class="icono movil" style="background-color:<?php echo $color_microsite; ?>;"><?php echo file_get_contents(get_stylesheet_directory().'/img/microsites/icono-movil.svg'); ?></div><input type="text" name="new_tlf_movil" id="new_tlf_movil" value="<?php the_field('telefono_movil'); ?>" placeholder="Teléfono móvil del centro"></li>
                                                </ul>
                                                <ul class="email">
                                                    <li class="elemento"><div class="icono mail" style="background-color:<?php echo $color_microsite; ?>;"><?php echo file_get_contents(get_stylesheet_directory().'/img/microsites/icono-email.svg'); ?></div><input type="text" name="new_e-mail" id="new_e-mail" value="<?php the_field('e-mail'); ?>" placeholder="e-mail del centro"></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <section class="cursos_genericos section_wrapper mcb-section-inner">
                                    ...
                                    <div class="cursos_genericos_1 column mcb-column one-third column_column">
                                        <div class="gutter">
											...
											$values = get_field('cursos_ofrecidos_tipo_autoescuela');
											$field = get_field_object('cursos_ofrecidos_tipo_autoescuela');
                                            ...
                                            <ul class="cursos">
												...
												{ ?>
                                                	<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php
														...
														foreach ($values as $value)
														{
															...
															{ ?>
																<input type="checkbox" checked="checked" name="<?php echo $choice_value; ?>" value="yes"><?php
																$found=true;
															}
														} // end foreach $values
														if(!$found)
                                                ...
                                                $cursos_anadidos=get_field('cursos_ofrecidos_tipo_autoescuela_adicionales');
												if($cursos_anadidos)
												{ ?>
                                                	<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php 
													...
													$i=0;
													foreach($cursos_anadidos as $curso_anadido)
													{ ?>
                                                ...
                                                <li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;">
                                                	<input type="text" class="add_curso_autoescuela" name="add_curso_autoescuela" placeholder="Añadir otro curso" />
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="cursos_genericos_2 textos column mcb-column one-third column_column">
                                        <div class="gutter">
                                            ...
                                            $values = get_field('cursos_ofrecidos_tipo_transporte');
											$field = get_field_object('cursos_ofrecidos_tipo_transporte');
											$choices = $field['choices']; ?>
                                            <ul class="cursos">
												<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php 
													_e('Cursos predefinidos (marca la casilla de los que quieras que aparezcan en la versión pública de la página):','academiadeltransportista'); ?>
												...
												$cursos_anadidos=get_field('cursos_ofrecidos_tipo_transporte_adicionales');
												if($cursos_anadidos)
												{ ?>
                                                	<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php 
														_e('Cursos adicionales añadidos (para eliminar uno, bórralo y guarda la página):','academiadeltransportista'); ?>
                                                ...
                                                <li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;">
                                                	<input type="text" class="add_curso_transporte" name="add_curso_transporte" placeholder="Añadir otro curso" />
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="cursos_genericos_3 textos column mcb-column one-third column_column">
                                        <div class="gutter">
                                            ...
                                            $values = get_field('cursos_ofrecidos_tipo_mas_cursos');
											$field = get_field_object('cursos_ofrecidos_tipo_mas_cursos');
											$choices = $field['choices']; ?>
                                            <ul class="cursos">
												<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php 
													_e('Cursos predefinidos (marca la casilla de los que quieras que aparezcan en la versión pública de la página):','academiadeltransportista'); ?>
												...
												$cursos_anadidos=get_field('cursos_ofrecidos_tipo_mas_cursos_adicionales');												
												if($cursos_anadidos)
												{ ?>
                                                	<li style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;"><?php 
														_e('Cursos adicionales añadidos (para eliminar uno, bórralo y guarda la página):','academiadeltransportista'); ?>
                                    ...
                                    <div class="edit_block cursos nuevo_curso">
                                    	...
                                    	<div class="curso" style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;">
                                        	<div class="gutter">
                                                ...
                                                <div class="clear"></div>
                                                <div class="the_input tipo_adr" style="display:none;">
                                        ...
                                        { 	
                                        	...
                                        	<div class="curso" curso_id="<?php echo $curso->ID; ?>" style="border-color:<?php if(get_field('color_microsite') != ''){ the_field('color_microsite'); }else{ ?>#FF6600<?php } ?>;">
                                            	<div class="gutter">
                                                    ...
                                                    <div class="clear"></div>
                                                    <div class="the_input tipo_adr" style="display:none;">
                                                        <span>Tipo de curso ADR:</span> <input type="text" name="tipo_adr_curso_<?php echo $curso->ID; ?>" value="<?php the_field('tipo_de_curso',$curso->ID); ?>" />
                                                    </div>
                                                    <div class="the_input">
