...
<div id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
		...
		<div class="section section-post-header">
			<div class="section_wrapper clearfix">
				...
				<div class="column one post-header">
					...
					<div class="button-love"><?php echo mfn_love() ?></div><?php
								...
								<div class="author-date">
									...
									<?php if( mfn_opts_get( 'mfn-seo-schema-type' ) ): ?>
										...
										<div itemprop="publisher" itemscope itemtype="https://schema.org/Organization" style="display:none;">
                                          ...
                                          <div itemscope="" itemprop="mainEntityOfPage" itemtype="https://schema.org/WebPage">
                                              <meta itemprop="url" content="http://www.academiadeltransportista.com">
                                              <meta itemprop="name" content="Academia del Transportista">
                                          </div>
                                          <meta itemprop="headline" content="<?php echo get_the_title();?>">
                                          <div itemprop="author" itemscope="" itemtype="https://schema.org/Person" class="">
                                          ...
                                          <div itemprop="publisher" itemscope itemtype="https://schema.org/LocalBusiness">
                                              ...
                                              ?>
                                              <meta itemprop="name" content="<?php echo $publisher_name; ?>">
                                              <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
                                                  <meta itemprop="url" content="<?php echo $publisher_logo_url; ?>">
                                                  <meta itemprop="width" content="<?php echo $publisher_logo_width; ?>">
                                                  <meta itemprop="height" content="<?php echo $publisher_logo_height; ?>">
                                              </div>
	...
	<div class="section section-post-related">
		<div class="section_wrapper clearfix">
        <section class="poner-cursos borde-separacion">
					<div class="container">
						<div class="elegir-curso">
                            <?php if( $post->ID == 558) { ?>
                            <h3 class="title-tranp-sanitario"><?php the_field('titulo_poner_cursos'); ?></h3>
                            <?php } else { ?>
                            <h4><?php the_field('titulo_poner_cursos'); ?></h4>
                            <?php } ?>
						</div>
						<div class="row">
						<?php
						$posts = get_field('elegir_curso');
						if( $posts ): ?>
							<?php foreach( $posts as $p ): // variable must NOT be called $post (IMPORTANT) ?>

								<!-- Content relationship -->
										<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
											<div class="bloque-cursos-post">
												<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
														<a href="<?php echo get_permalink( $p->ID ); ?>">
														<?php $featured_image = get_the_post_thumbnail( $p->ID,'large' ); ?>
														<div class="grid">
															<div class="effect-lily">
																<?php echo$featured_image ?>
															</div>
														</div>
															<h4 class="titulo-cursos-post"><?php echo get_the_title( $p->ID ); ?></h4>
														</a>
													</div>
												</div>
											</div>
				...
				if( mfn_opts_get( 'blog-related' ) && $aCategories = wp_get_post_categories( get_the_ID() ) ){
					...
					if( $query_related_posts->have_posts() ){
						...
						echo '<div class="section-related-adjustment '. $related_style .'">';
							...
							echo '<h3 class="title-tranp-sanitario">'. $translate['related'] .'</h3>';
