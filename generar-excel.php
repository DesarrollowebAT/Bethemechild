...
header('Content-Disposition: attachment; filename=webcentrosNEW2.xls');
if(file_exists('/var/www/vhosts/academiadeltransportista.com/httpdocs/wp-content/plugins/at-importer/webcentros.txt'))
{
	$texto=file_get_contents('/var/www/vhosts/academiadeltransportista.com/httpdocs/wp-content/plugins/at-importer/webcentros.txt');
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="100%">
		...
		foreach($paginas as $pagina)
		{
			...
			{
				/*print_r($pagina);*/
				$textos_sobrantes=array('Distribución por Comunidad Autónoma y Provincia','Ministerio de Fomento','Fecha: 10-10-2018');
				...
				{ 
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities($provincia_texto); ?></td>
                        <td><?php echo htmlentities($municipio_texto); ?></td>
