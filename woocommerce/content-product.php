...
{
	$classes[]='product_cat_'.$term->term_id;
}
...
<li <?php post_class( $classes ); ?>>
    ...
    <?php
		if (get_field('cartel')!='')
		{ ?>
        	<p class="caja-cartel"><?php the_field('cartel'); ?></p><?php
        }
		
		$tipo_curso=get_field('tipo_de_curso');
		if($tipo_curso)
		{ ?>
        	<p class="categoria-producto"><?php echo $tipo_curso['label']; ?></p><?php			
		}
		else
		{ ?>
			<p class="categoria-producto"><?php echo $product->get_categories(); ?></p><?php
		}
		...
		<div class="spritemasflechaicon-flecha icon-flecha-producto"></div>
        <div class="spritemasflechaicon-flecha-blc icon-flecha-producto-blanco"></div>
        <!--<img class="icon-flecha-producto" src="https://www.academiadeltransportista.com/wp-content/uploads/2018/06/icon-flecha.png">
        <img class="icon-flecha-producto-blanco" src="https://www.academiadeltransportista.com/wp-content/uploads/2018/06/icon-flecha-blc.png">-->
