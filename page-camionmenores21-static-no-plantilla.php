<?php
/**
 * Template name: CAMIÓN - MENORES 21
 */
		...
		<div class="content_wrapper clearfix">
			...
			<div class="sections_group">
				<div class="entry-content" itemprop="mainContentOfPage">
                                ...
                                <div class="section_wrapper mcb-section-inner">
                                    ...
                                    <div class="wrap mcb-wrap one slide-cap valign-top clearfix">
                                        <div class="mcb-wrap-inner">
                                            ...
                                            <div class="column mcb-column one-third column_column column-margin-">
                                                <div class="column_attr clearfix" style="">
                                                    <h2 class="title_landing_course_type <?php if(is_page(33609)|| is_page(81889) || is_page(33619) || is_page(33583)){ ?>vacio<?php } ?>"><?php the_sub_field('titulo_columna_2'); ?></h2>
													<div class="text_landing_course_type grow-column altura-text"><?php the_sub_field('texto_columna_2'); ?></div><?php 
													if(!is_page(33609)&& !is_page(81889) && !is_page(33619) && !is_page(33583))
													{ ?>
									...
									{
										if(is_page(33609)  || is_page(81889) || is_page(33583) || is_page(33619) || is_page(45045) || is_page(71674))
										{ ?>
                    ...
                    <?php
                    if(is_page(33609)  || is_page(81889) || is_page(33583))
					{ ?>
                    <section class="section mcb-section examen-section">
                                    ...
                                    <div class="column mcb-column two-fifth column_column  column-margin- form_title">
                                    	<div class="column_attr clearfix" style="">
	                                        <div class="intro-consejos-seguridad">
												...
												elseif(is_page(33609) || is_page(81889))
												{ ?>
