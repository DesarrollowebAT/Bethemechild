...
<!-- body --><?php 
if(has_term(array(27,55,54),'product_cat',get_the_id()) && !has_term(array(53),'product_cat',get_the_id()))
{
	$body_class='not_linea_900';
} ?>
<body <?php body_class($body_class); ?>><?php 
if(!is_page(8657) && !is_page(8666) && !is_page(8663) && !is_page(33609) && !is_page(33619) && !is_page(33583) && !is_page(45236) && !is_singular('autoescuela'))
{ 
	if(has_term(array(53),'product_cat',get_the_id()))
	{ ?>
        <div class="cabecera_linea_900 show_for_mobile test3">
