                	...
                	<div class="items_group clearfix">
                    	<div class="woocommerce woocommerce-page">
                            <div class="column one woocommerce-content">
                                ...
                                $autoescuelas_en_municipio=get_posts(
									array(
										'numberposts' => -1,
								...
								$google_place=get_google_place($municipio_elegido['label'].','.$provincia_elegida['label']);
								$location=array('latitud' => $google_place->results[0]->geometry->location->lat,'longitud' => $google_place->results[0]->geometry->location->lng);
								$autoescuelas_en_radio=get_centros_en_radio(15,$location,$provincia_elegida['label'],'cercania',$autoescuelas_en_municipio);
								$autoescuelas=array_merge($autoescuelas_en_municipio,$autoescuelas_en_radio); ?>
                                <div class="title">
								...
								{ ?>
                                   	<p class="contador-ciudades"><?php if(count($autoescuelas) > 1){ ?>Estos son las <span><?php echo count($autoescuelas); ?></span><?php }else{ ?>Esta es la<?php } if(count($autoescuelas) > 1){ ?> autoescuelas<?php }else{ ?> autoescuela<?php } ?>  más <?php if(count($autoescuelas) > 1){ ?>cercanas<?php }else{ ?>cercana<?php } ?> a ti: consigue los datos de contacto de cada autoescuela pinchando en ellas</p><?php
                                }
								else
								{ ?>
                                        ...
                                        <div class="mapa panel">
                                            <div class="acf-map listado"><?php
                                                foreach($autoescuelas as $autoescuela)
                                                {
													...
													{ 
														$cursos=get_cursos_autoescuela($autoescuela);
														if($cursos)
														{ ?>
