		...
		<div class="content_wrapper clearfix">
			...
			<div class="sections_group">
				...
				<div class="entry-content" itemprop="mainContentOfPage"><?php
					...
					global $wpdb;
					foreach($provincias as $cod => $nom)
					{
						if($nom != 'Álava')
						{
							$sitio=get_google_place($nom.',+España');
							foreach($sitio->results[0]->address_components as $address_component)
							{
								if($address_component->types[0] == 'administrative_area_level_2')
								{
									$wpdb->insert(
										'wp_location_attrs_municipios',
										array(
											'cod' => $cod,
											'orig_name' => $nom,
											'g_name' => $address_component->long_name,
											'orig_name_sanitized' => sanitize_title($nom),
											'g_name_sanitized' => sanitize_title($address_component->long_name)
										)
									);
									echo $cod.' - '.$nom.' - '.$address_component->long_name.' - '.sanitize_title($nom).' - '.sanitize_title($address_component->long_name).'<br />';
								}
							}
						}
					}*/
					...
					$municipios=array(
						...
						"299023" => "Villanueva de la Concepción",
					...
					global $wpdb;
					/*foreach($municipios as $cod => $nom)
					{
						if($nom != 'Alegría-Dulantzi' && $nom != 'Amurrio')
						{
							$sitio=get_google_place($nom.',+España');
					...
					/*$pedido='{"id":4407,"parent_id":0,"status":"on-hold","currency":"EUR","version":"3.4.5","prices_include_tax":false,"date_created":{"date":"2019-03-14 17:26:36.000000","timezone_type":1,"timezone":"+00:00"},"date_modified":{"date":"2019-03-14 17:26:36.000000","timezone_type":1,"timezone":"+00:00"},"discount_total":"30","discount_tax":"0","shipping_total":"0.00","shipping_tax":"0","cart_tax":"0","total":"270.00","total_tax":"0","customer_id":6,"order_key":"wc_order_5c8a8eccf105b","billing":{"first_name":"Test Roiting","last_name":"Roiting","company":"","address_1":"C\/Cuenca 51","address_2":"","city":"Valencia","state":"V","postcode":"46900","country":"ES","email":"rhurtado@roiting.com","phone":"999999999"},"shipping":{"first_name":"","last_name":"","company":"","address_1":"","address_2":"","city":"","state":"","postcode":"","country":""},"payment_method":"bacs","payment_method_title":"Transferencia bancaria directa","transaction_id":"","customer_ip_address":"79.151.197.141","customer_user_agent":"mozilla\/5.0 (windows nt 10.0; win64; x64; rv:65.0) gecko\/20100101 firefox\/65.0","created_via":"checkout","customer_note":"","date_completed":null,"date_paid":null,"cart_hash":"07140bf0fd6e80637b7e8842a7d0f354","number":"4407","meta_data":[{"id":64862,"key":"_wc_customer_order_csv_export_is_exported","value":"0"},{"id":64863,"key":"_wc_customer_order_csv_export_customer_is_exported","value":"0"},{"id":64908,"key":"_billing_nif","value":"48529051v"}],"line_items":{"161":{}},"tax_lines":[],"shipping_lines":[],"fee_lines":[],"coupon_lines":{"162":{}}}';
					
					mbm_alter_shipping('rohurmar@gmail.com',$pedido);*/
