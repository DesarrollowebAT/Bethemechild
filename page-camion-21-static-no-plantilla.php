		...
		<div class="content_wrapper clearfix">
			...
			<div class="sections_group">
				<div class="entry-content" itemprop="mainContentOfPage">
                                    ...
                                    <div class="column mcb-column two-fifth column_column  column-margin- full-width-movil">
                                    	<div class="column_attr clearfix" style="">
											<div class="caja-form-ciudad"><?php
												...
												echo do_shortcode('[contact-form-7 id="81926" title="Formulario ciudad CARNET CAMION MENOR 21"]');  ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="section_wrapper mcb-section-inner">
                                    ...
                                    <div class="wrap mcb-wrap one slide-cap valign-top clearfix">
                                        <div class="mcb-wrap-inner">
                                            ...
                                            <div class="column mcb-column one-third column_column column-margin-">
                                                <div class="column_attr clearfix" style="">
                                                    <h2 class="title_landing_course_type <?php if(is_page(81889) || is_page(33619) || is_page(33583)){ ?>vacio<?php } ?>"><?php the_sub_field('titulo_columna_2'); ?></h2>
													<div class="text_landing_course_type grow-column altura-text"><?php the_sub_field('texto_columna_2'); ?></div><?php 
													if(!is_page(81889) && !is_page(33619) && !is_page(33583))
													{ ?>
									...
									{
										if(is_page(81889) || is_page(33583) || is_page(33619) || is_page(45045) || is_page(71674))
										{ ?>
													...
													<div class="column mcb-column one column_column  column-margin-">
														<div class="column_attr clearfix" style=""><?php
															...
															{ ?>
                                                                ...
                                                                if(is_page(81889) || is_page(33583) || is_page(33619))
                                                                {
                    ...
                    <?php
                    if(is_page(81889) || is_page(33583))
					{ ?>
                    <section class="section mcb-section examen-section">
                                    ...
                                    <div class="column mcb-column two-fifth column_column column-margin- form_column segundo_formulario_pedaogicas">
                                    	<div class="column_attr clearfix" style="">
                                            ...
                                            if(is_page(81889))
												...
												/*echo do_shortcode('[contact-form-7 id="9042" title="Formulario ciudad renovación CAP GENÉRICO"]');*/S ?>
                                            </div>
										</div>
                                    </div>
                                </div>
